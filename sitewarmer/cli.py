...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--interval", type=int, default=300, help="Seconds between cycles in continuous mode (default: 300).")
    ...
    parser.add_argument("--user-agent", default=f"sitewarmer/{__version__}", help="Custom User-Agent header.")
    parser.add_argument("--discover", choices=["none", "sitemap", "links", "both"], default="none", help="Optional URL discovery mode.")
    parser.add_argument("--limit", type=int, default=10, help="Maximum discovered URLs to add per run (default: 10).")
    ...
    parser.add_argument("--allow-external", action="store_true", help="Allow discovered external URLs.")
